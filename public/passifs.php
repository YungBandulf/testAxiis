...
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
            <form action="../model/ajoutPassif.php" method="post">

                <label for "date_passif>Date de création:</label>
                <input type="datetime-local" name="date_passif" id="date_passif" placeholder="Saisir la date de création">
                ...
                <button type="submit">Ajouter passif</button>
            </form>
        </div>
    </div>
</div>
...
document.getElementById('categoriePrincipale').addEventListener('change', function() {
    ...
    var options = {
        passifsCourants: ['Fournisseurs (comptes créditeurs)', 'Emprunts court terme', 'Dettes fiscales et sociales (TVA due, cotisations sociales)', 'Autres dettes (loyers, charges à payer, etc.)', 'Passifs à long terme'],
        passifsLongTerme: ['Emprunts à long terme', 'Provisions pour risques et charges']
    };
