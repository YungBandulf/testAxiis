...
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
            <form action="../model/ajoutDevis.php" method="post">

                <label for "date_devis>Date de création </label>
                <input type="datetime-local" name="date_devis" id="date_devis" placeholder="Saisir la date de création">
